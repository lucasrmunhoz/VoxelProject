...
//
// Fonte: espelho 1:1 do .cs no repo. Ajuste mínimo do PR-02:
// - Encapsular todos os tipos no namespace `RoomsData` para alinhar com os aliases
//   usados por GameFlowManager/BaseRoomGenerator/GameSignals/RoomTriggerController.
//   (Ex.: `using RoomPlan = RoomsData.RoomPlan;`)
//
namespace RoomsData
{
    /// <summary>
